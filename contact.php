                                ...
                                <div class="col-md-5">
                                    ...
                                    <form method="POST" action="contact.php" >
                                        <div class="form-group">
                                            <input id="inputNom" class="form-control mb-2"  type="text"  name="nom" placeholder="Votre nom" value="" />
                                            <input id="inputEmail" class="form-control mb-2" type="email" name="mail" placeholder="Votre email" value="" />
                                            <input id="inputSujet" class="form-control mb-2" type="text" name="sujet" placeholder="Sujet du message" value="" />
                                            <textarea id="txtMessage" class="form-control" name="message" placeholder="Votre message" rows="3"> </textarea>
                                        </div>
                                        <button id="btnEnvoyer" disabled class="btn btn-secondary" type="submit" name="button" value="Envoyer !">Envoyer</button>
                                    </form>
                                </div>
                            </div>
                        </div>
      ...
      <div class="container text-center text-md-left mt-5" style="background-color:lightgrey">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            ...
            <p>Que vous soyez indépendant ou particulier, votre demande et votre satisfaction sont nos premiers critères de collaboration.</p>
          </div>
